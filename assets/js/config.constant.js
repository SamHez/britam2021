...
app.constant('JS_REQUIRES', {
    ...
    scripts: {
        ...
        'organisationCtrl': 'assets/js/controllers/organisationCtrl.js', 
        'clientCtrl': 'assets/js/controllers/clientCtrl.js',
        'claimsCtrl': 'assets/js/controllers/claimsCtrl.js',
        'ReportController': 'assets/js/controllers/ReportController.js',
        'stickerCtrl': 'assets/js/controllers/stickerCtrl.js',
        'stickerNoCtrl': 'assets/js/controllers/stickerNoCtrl.js',
        ...
        'Data': 'assets/js/controllers/Data.js',
